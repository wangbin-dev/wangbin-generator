...
import com.wangbing.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "wangbin-dev");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.wangbin");
